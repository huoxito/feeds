...
export default () =>
  <a className="no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center mr1 tc br2 pa2" href="/auth" title="Sign in with GitHub">
